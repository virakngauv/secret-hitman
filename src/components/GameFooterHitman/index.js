  ...
  return (
    <Row>
      <Col className="d-flex">
        ...
        <Button className="btn-menu btn-game-footer ms-auto me-auto" size="sm" variant="outline-secondary" id="end-turn-button" onClick={handleFinishTurn} disabled={isInactive}>Finish Turn</Button>
      </Col>
    </Row>
  );
}
